      ...
      <div class="row">
        <div class="col-sm-12">
          <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
            <thead>
              <tr role="row">
                <th width="30%" class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Name: activate to sort column descending" aria-sort="ascending">Tên sản phẩm</th>
                <th width="25%" class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Name: activate to sort column descending" aria-sort="ascending">Đánh giá</th>
            ...
            <tbody>
              @foreach($comments as $value)
                <tr role="row" class="odd">
                  ...
                  <td>{{ $value->rating }}</td>
                  <td>
                    <form class="row" method="POST" action="{{ route('comment.deleteProductComment', ['id' => $value->id, 'product_id' => $value->product_id]) }}" onsubmit = "return confirm('Chắc chắn xoá?')">
            ...
            <tfoot>
              <tr>
                ...
                <th width="10%" rowspan="1" colspan="1">Đánh giá</th>
